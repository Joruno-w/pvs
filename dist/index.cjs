...
const require$$0 = require('node:fs/promises');
const require$$1 = require('node:path');
const require$$2 = require('shelljs');
const require$$3 = require('fs-extra');
const require$$4 = require('kleur');
const require$$5 = require('ora');
...
const { readFile } = require$$0__default;
const { resolve } = require$$1__default;
const shell = require$$2__default;
const { pathExistsSync } = require$$3__default;
const c = require$$4__default;
const ora = require$$5__default;
