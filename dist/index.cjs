...
const require$$0$3 = require('node:fs/promises');
const require$$1$1 = require('node:path');
const require$$2 = require('shelljs');
...
const require$$4$1 = require('kleur');
const require$$5$1 = require('ora');
const require$$6 = require('prompts');
...
const require$$5__default$1 = /*#__PURE__*/_interopDefaultLegacy(require$$5$1);
...
var fs$h = require$$0__default$2;
var polyfills = polyfills$1;
var legacy = legacyStreams;
var clone = clone_1;

var util$1 = require$$4__default;
...
if (!fs$h[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function() {
      ...
      require$$5__default.equal(fs$h[gracefulQueue].length, 0);
    });
  }
}
...
const assert = require$$5__default;
...
const { readFile } = require$$0__default$3;
const { resolve } = require$$1__default$1;
const shell = require$$2__default;
const { pathExistsSync } = lib;
const c = require$$4__default$1;
const ora = require$$5__default$1;
const prompts = require$$6__default;
const pkg = require$$7;
